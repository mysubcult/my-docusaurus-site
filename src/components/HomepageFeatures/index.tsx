...
const FeatureList: FeatureItem[] = [
  ...
  {
    title: 'Эффективное Использование Оборудования',
    Svg: require('@site/static/img/undraw_docusaurus_react.svg').default,
    description: (
      <>
        Наши инструкции помогут вам максимально эффективно использовать диагностическое оборудование. Мы предоставляем подробные руководства по настройке и использованию оборудования, чтобы вы могли быстро и точно диагностировать проблемы в автомобилях.
      </>
    ),
  },
];
