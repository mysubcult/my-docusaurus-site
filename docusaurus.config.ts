  ...
  scripts: [
    {
      ...
      innerHTML: `
        var LHC_API = LHC_API||{};
        LHC_API.args = {mode:'widget',lhc_base_url:'//xn----7sbabnedajkp5ap8aokkew.xn--p1ai/index.php/',wheight:450,wwidth:350,pheight:520,pwidth:500,domain:'docs.xn--80aajcuv3afm.xn--p1ai',department:["1"],check_messages:false};
        (function() {
